    ...
    <div class="columns is-mobile">
        ...
        <div class="blog-list-container">
          <section class="section blog">
            <div class="blog-header">
              <h1 class="title is-3 has-text-weight-bold">Some Blog Title</h1>
              <h2 class="subtitle is-5">Some Blog Subtitle</h2>
            </div>
            <div class="blog-content">
              by Alex Kerketta, Feb 13
            </div>
          </section>
          <section class="section blog">
            <div class="blog-header">
      ...
      <div class="column is-3 is-narrow">
        <div class="featured-blog-header">
          <h1 class="title is-4 has-text-weight-bold is-uppercase">
            Featured Posts
          </h1>
        </div>
        <div class="featured-blog-list-container">
          <div class="columns">
            <div class="column">
              <section class="featured-blog">
                <nuxt-link to="" class="featured-blog-title has-text-weight-light"
                >Some favorite blog 1</nuxt-link
              >
              </section>
              <section class="featured-blog">
                <p>
                  <nuxt-link to="" class="featured-blog-title has-text-weight-light"
                  >Some favorite blog 2</nuxt-link
                ></p>
              </section>
            </div>
          </div>
